...
export default function ProductDetails() {
    ...
    const hasDiscount = Boolean(product.is_deal && discountPercent > 0);
            ...
            <div className="row g-5">
                ...
                <div className="col-md-6">
                    ...
                    <div className="mb-2 text-warning">
                        Rating <small className="text-muted">(120 reviews)</small>
                    </div>

                    <div className="mb-3">
                        <h2 className="text-danger fw-bold mb-1">
                            N{Number(discountedPrice).toLocaleString()}
                        </h2>

                        {hasDiscount && (
                            <>
                                <span className="text-muted text-decoration-line-through me-2">
                                    N{Number(basePrice).toLocaleString()}
                                </span>
